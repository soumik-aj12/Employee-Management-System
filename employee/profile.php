...
<body style="background-size: cover;background-image: url(&quot;../assets/img/Employee.jpg&quot;);background-repeat: no-repeat;background-color: rgb(255,255,255);">
        ...
        <div class="container" style="max-width:100%"><img src="../assets/img/ems.jpg" alt="e" style="width: 240px;"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-1" style="padding: 0px;">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item item" role="presentation"><a class="nav-link" href="view_project">VIEW PROJECT</a></li>
                    </ul>
                    <div class="row">
                        <div class="col">
    ...
    <center><h3 class="text-dark mb-4" style="font-size:3rem"><b>My Profile</b></h3></center>
        <div class="row mb-3">
            <div class="col-lg-4">
                <div class="card mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="apply_leave.php" method="post">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group"><label for="from_date" required><strong>From Date <span style="color:red">*</span></strong></label>
                                    <input class="form-control" type="date"  id="from_date" name="Leave_from" placeholder="From Date" min="<?php echo date("Y-m-d") ?>">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group"><label for="to_date" required><strong>To Date <span style="color:red">*</span></strong></label>
                                    <input class="form-control" type="date" id="to_date" name="Leave_to" placeholder="To Date" min="<?php echo date("Y-m-d") ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group"><label for="reason" required><strong>Reason for Leave</strong></label>
                        ...
                        ?>
                    <div class="row">
                        <div class="col"><h5>Leaves Taken</h5>
                            <?php
                            if($num==0){
                                echo 0;
                                }else{
                        ...
                        <div class="col"><h5>Leaves Remaining</h5>
                            <?php 
                                if($num==0){
